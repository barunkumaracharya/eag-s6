...
def observe(
    ...
    if not history:
        ...
        system = (
            ...
            f"- If needed, you can also attach the 'Generated Artifact ID' of actions in history to the attach_artifact_id list of the same goal, if the goal is unfinished."
